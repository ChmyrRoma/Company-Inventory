...
jest.mock('react-router-dom', () => {
    const actualModule = jest.requireActual<typeof import('react-router-dom')>('react-router-dom');
    return {
        ...actualModule,
        useNavigate: jest.fn(),
    };
...
describe('Header', () => {
    ...
    it('handles search input updates and performs subsequent actions', async () => {
        ...
        (jest.requireMock('react-router-dom') as { useNavigate: jest.Mock }).useNavigate.mockReturnValue(mockNavigate);
